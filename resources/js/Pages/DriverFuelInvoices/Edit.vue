...
function submit() {
    ...
    form.put(`/driver-fuel-invoices/${props.invoice.id}`, {
        preserveScroll: true,
    });
}
</script>
...
<template>
    <Head title="Modifier Facture Carburant" />

    <div class="fuel-page">
        <div class="page-header-card">
            <div>
                <p class="eyebrow">Gestion carburant</p>
                <h1>Modifier facture chauffeur</h1>
                <p class="subtitle">
        ...
        <div class="fuel-grid">
                ...
                <div class="card block-card">
                    <div class="card-head">
                        <div>
                            ...
                            <p>
                                Vous pouvez modifier le chauffeur, la période et
                ...
                <div class="card block-card">
                    ...
                    <div v-else class="empty-state">
                        ...
                        <p>
                            ...
                            afficher la nouvelle liste selon le chauffeur et la
                            période choisis.
                        </p>
                    </div>
                </div>
            ...
            <div class="side-column">
                ...
                <div class="card helper-card">
                    ...
                    <ul>
                        <li>
                            Modifiez d’abord le chauffeur ou la période si
                            besoin.
                        </li>
                        <li>
