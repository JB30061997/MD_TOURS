...
function goDelete() {
    ...
    router.delete(`/driver-fuel-invoices/${props.invoice.id}`, {
        preserveScroll: true,
    });
}
</script>
    ...
    <div class="show-page">
        ...
        <div class="hero-card">
            ...
            <div class="hero-left">
                ...
                <!-- <p class="mini-title">MD TOURS • Facture chauffeur</p> -->
                <h1 class="text-white">Facture #{{ invoice.id }}</h1>
                <!-- <p class="hero-text">
                    Consultez rapidement les informations de la facture
                    carburant, le chauffeur concerné, la période, le montant et
                    tous les plannings liés dans une interface moderne et
                    visuellement forte.
                </p> -->
                ...
                <!-- <div class="hero-inline-stats">
                    <div class="hero-stat">
                        <span>Montant</span>
                        <strong>{{ formatMoney(invoice.total_amount) }} MAD</strong>
                    </div>
            ...
            <div class="hero-actions">
                <Link href="/driver-fuel-invoices" class="hero-btn light">
                    Retour
                </Link>
                ...
                <div class="box-card glass-card">
                    ...
                    <div class="details-grid">
                        <div class="info-card">
                            ...
                            <strong class="info-value">#{{ invoice.id }}</strong>
                        </div>
                ...
                <div class="box-card">
                    <div class="section-head">
                        <div>
                            ...
                            <p>
                                Liste des services et plannings sélectionnés pour
                                cette facture.
                            </p>
                        </div>
                    </div>
            ...
            <div class="side-column">
                <div class="profile-card">
                    <div class="profile-top">
                        ...
                        <div>
                            <h3>{{ invoice.driver?.name || "-" }}</h3>
                            <p>Chauffeur concerné</p>
                        </div>
                    </div>

                    <div class="profile-line">
                        <span>Téléphone</span>
                        <strong>{{ invoice.driver?.phone || "-" }}</strong>
                    </div>

                    <div class="profile-line">
                        <span>Email</span>
                        <strong>{{ invoice.driver?.email || "-" }}</strong>
                    </div>

                    <div class="profile-line">
                        <span>Status</span>
                        <strong>{{ invoice.driver?.status || "-" }}</strong>
                    </div>
                </div>
                ...
                <!-- <div class="action-card">
                    ...
                    <Link
                        :href="`/driver-fuel-invoices/${invoice.id}/edit`"
                        class="side-btn edit-btn"
                    >
                        Modifier la facture
                    </Link>

                    <Link
                        href="/driver-fuel-invoices"
                        class="side-btn back-btn"
                    >
                        Retour à la liste
                    </Link>

                    <button class="side-btn delete-btn" @click="goDelete">
...
.show-page {
    ...
    min-height: 100vh;
    background:
        radial-gradient(circle at top left, rgba(220, 38, 38, 0.10), transparent 25%),
        radial-gradient(circle at top right, rgba(239, 68, 68, 0.08), transparent 20%),
        #f6f7fb;
}
