                    ...
                    <div class="hero-left">
                        ...
                        <div>
                            ...
                            <p class="hero-subtitle mb-0">
                                Update the client information and the related client supplier.
                            </p>
                        </div>
                    </div>
                ...
                <form @submit.prevent="submit">
                    <div class="row g-4">
                        <div class="col-md-6">
                            ...
                            >
                                <option value="">Select a client supplier</option>
                                <option
                            ...
                            <div v-if="form.errors.supplier_client_id" class="error-text">
