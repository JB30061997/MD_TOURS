        ...
        <div class="container-fluid py-4">
            <div class="form-card">
                <div class="form-header">
                    <div>
                        <h3 class="form-title">Ajouter un client</h3>
                        <p class="form-subtitle">
                            Remplissez les informations du client et choisissez son fournisseur client.
                        </p>
                    </div>
                ...
                <form @submit.prevent="submit">
                    <div class="row g-4">
                        <div class="col-md-6">
                            ...
                            >
                                <option value="">Sélectionner un fournisseur client</option>
                                <option
                        ...
                        <div class="col-md-6">
                            ...
                            <div v-if="form.errors.full_name" class="text-danger small mt-1">
                        ...
                        <div class="col-12 d-flex gap-2 flex-wrap">
                            ...
                            <Link href="/clients" class="btn btn-light-soft px-4">
                                Annuler
                            </Link>
                        </div>
                    </div>
