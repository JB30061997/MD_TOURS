...
const form = useForm({
    ...
    status: props.guide.status || 'Disponible',
            ...
            <div class="card border-0 shadow-sm rounded-4">
                <div class="card-body p-4 p-lg-5">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            <h3 class="fw-bold mb-1">Modifier le guide</h3>
                            <p class="text-muted mb-0">Mettre à jour les informations du guide.</p>
                        </div>
                        <Link href="/guides" class="btn btn-light rounded-3">Retour</Link>
                    </div>
