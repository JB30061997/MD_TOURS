...
const form = useForm({
    designation: props.typeSupplier.designation || "",
    description: props.typeSupplier.description || "",
});

const submit = () => {
    form.put(`/type-suppliers/${props.typeSupplier.id}`);
};
</script>

<template>
    <Head title="Modifier Type Supplier" />
