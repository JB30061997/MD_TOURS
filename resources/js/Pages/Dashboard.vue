...
.actions-head { position: sticky; right: 0; z-index: 3; min-width: 132px; background: linear-gradient(180deg, #eef2ff, #e0e7ff) !important; color: #4338ca !important; }
.planning-row-actions { position: sticky; right: 0; z-index: 2; display: flex; gap: 6px; min-width: 132px; background: rgba(255,255,255,.96); box-shadow: -8px 0 16px rgba(15,23,42,.05); }
...
.planning-row-actions .compact-action-button { justify-content: center; width: 34px; min-width: 34px; padding: 6px; }
.planning-row-actions .compact-action-button span { display: none; }
