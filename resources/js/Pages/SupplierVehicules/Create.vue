...
const submit = () => {
    form.post(route("supplier-vehicules.store"), {
        preserveScroll: true,
        onSuccess: () => {
            Swal.fire({
                toast: true,
                position: "top-end",
                icon: "success",
                title: "Vehicle supplier created successfully",
...
<template>
    <Head title="Create Vehicle Supplier" />
            ...
            <div class="hero-card mb-4">
                ...
                <div class="hero-content">
                    <div class="hero-left">
                        ...
                        <div>
                            <h1 class="hero-title">New Vehicle Supplier</h1>
                            <p class="hero-subtitle mb-0">
                                Add a new vehicle supplier.
                            </p>
                        </div>
                    </div>
