...
const destroySupplierVehicule = (id) => {
    Swal.fire({
        title: "Supprimer ce supplier véhicule ?",
...
<template>
    <Head title="Supplier Véhicules" />

    <div class="page-content">
        <div class="container-fluid">
            <div class="hero-card mb-4">
                <div>
                    <h1>Supplier Véhicules</h1>
                    <p>Gestion des fournisseurs de véhicules.</p>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table align-middle table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr v-if="supplierVehicules.data.length === 0">
                                <td
                                    colspan="9"
                                    class="text-center py-5 text-muted"
                                >
                                    Aucun supplier véhicule trouvé.
                                </td>
                            </tr>
                        </tbody>
                    </table>
